...
var inputID = document.getElementById('id-input').value;
...
function createPostElement(postId, title, text, author, authorId, authorPic) {
  ...
  addCommentForm.onsubmit = function(e) {
    ...
    firebase.database().ref('/users/' + currentUID).once('value').then(function(snapshot) {
      ...
      createNewComment(postId, username, uid, commentInput.value);
      commentInput.value = '';
...
function onAuthStateChanged(user) {
  ...
  if (user) {
    if(document.getElementById('id-input').value != ""){
        inputID = document.getElementById('id-input').value;
        console.log(user.uid);
        console.log(inputID);
        currentUID = user.uid;
        splashPage.style.display = 'none';
        writeUserData(user.uid, inputID, user.photoURL);
        ...
        firebase.database().ref('/users/' + user.uid).once('value').then(function(snapshot) {
            ...
            currentUID = user.uid;
            splashPage.style.display = 'none';
            writeUserData(user.uid, username, user.photoURL);
            startDatabaseQueries();
          });
    }
